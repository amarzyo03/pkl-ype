...
@section('content')
    <form action="{{ route('jurusan.save') }}" method="post">
        ...
        <section class="hero">
            <div class="hero-text"><span class="eyebrow">Master · Jurusan · Add</span>
                <h1 class="hero-title">Add <span class="accent">Jurusan</span></h1>
                <p class="hero-sub">Form for adding a new major to the system.</p>
            </div>
            ...
            <section class="col-12 card">
                <div class="card-head">
                    <div class="card-title-wrap">
                        ...
                        <h2 class="card-title">Add New Jurusan</h2>
                    </div>
                </div>
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input id="kode" class="input" type="text" name="kode" value="{{ old('kode') }}"
                            placeholder="Kode Jurusan" autofocus required>
                    </div>
                    <div class="field">
