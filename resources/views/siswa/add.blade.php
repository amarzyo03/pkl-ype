...
@section('content')
    <form action="{{ route('siswa.save') }}" method="post">
        ...
        <section class="hero">
            <div class="hero-text"><span class="eyebrow">Master · Siswa · Add</span>
                <h1 class="hero-title">Add <span class="accent">Siswa</span></h1>
                <p class="hero-sub">Form for adding a new student to the system.</p>
            </div>
            ...
            <section class="col-12 card">
                <div class="card-head">
                    <div class="card-title-wrap">
                        ...
                        <h2 class="card-title">Add New Siswa</h2>
                    </div>
                </div>
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input id="nis" class="input" type="text" name="nis" value="{{ old('nis') }}"
                            placeholder="NIS" autofocus required>
                    </div>
                    <div class="field">
                        <label class="field-label" for="nisn">NISN
                            <span class="req">*</span>
                        </label>
                        <input id="nisn" class="input" type="text" name="nisn" value="{{ old('nisn') }}"
